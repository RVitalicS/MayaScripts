...
class DockableWindow(MayaQWidgetDockableMixin, QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        # collect names of arnold shader parameters
        ...
        self.icons_dir = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'icons')
        self.material_tag_items = [
            ['Shader01', os.path.join(self.icons_dir, 'mtlDefault.jpeg')],
            ['Shader02', os.path.join(self.icons_dir, 'mtlDefault.jpeg')]
            ]
        ...
        self.build_tree_item('Material', self.material_tag_items, self.tree_root)
            ...
            for item in self.shader_parameter_items:
                if item.checkState() == QtCore.Qt.CheckState.Checked:
                    ...
                    for attribute_path in attribute_path_list:
                        setAttr(attribute_path, '{}<udim>.tex'.format(item.text()))
